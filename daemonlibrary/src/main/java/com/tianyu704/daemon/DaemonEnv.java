...
public final class DaemonEnv {
     ...
     */
    public static final String ACTION_START_JOB_ALARM_SUB = "com.tianyu704.START_JOB_ALARM_SUB";
    public static final String ACTION_CANCEL_JOB_ALARM_SUB = "com.tianyu704.CANCEL_JOB_ALARM_SUB";
    ...
    public static void startServiceMayBind(@NonNull final Context context,
        ...
        if (!connection.mConnectedState) {
            Log.d("tianyu704", "启动并绑定服务 ：" + serviceClass.getSimpleName());
    ...
    public static void startServiceSafely(Context context, Class<? extends Service> i) {
        Log.d("tianyu704", "安全启动服务。。: " + i.getSimpleName());
        try {
    ...
    public static void sendStartWorkBroadcast(Context context) {
        Log.d("tianyu704", "发送开始广播。。。。");
        // 以广播的形式通知所有进程终止
        Intent intent = new Intent(ACTION_START_JOB_ALARM_SUB);
        //第一个参数为包的路径，第二个参数为类名
        intent.setComponent(new ComponentName("com.tianyu704.daemonlibrary", "com.tianyu704.daemon.watch.WakeUpReceiver$StartWatchReceiver"));
